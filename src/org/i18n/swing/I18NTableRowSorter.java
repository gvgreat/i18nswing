 ...
 */
public class I18NTableRowSorter<T extends TableModel> extends TableRowSorter<T> {

	/**
	 * @param model_p
	 */
	public I18NTableRowSorter(T model_p) {
		super(model_p);
	}
	...
	class TableCellValueComparator implements Comparator<TableCellValue> {
		...
		public int compare(TableCellValue cell1, TableCellValue cell2) {
			...
			if (cell1.row == getModelWrapper().getRowCount() - 1)
				...
				if (delegate != null) return delegate.compare(cell1.value, cell2.value);
